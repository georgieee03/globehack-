...
- [x] 1. Shared types and constants
  - [x] 1.1 Create shared Recovery Intelligence types
  ...
  - [x] 1.2 Create pad placement lookup table
  ...
  - [x] 1.3 Create modality mix lookup table
  ...
  - [x] 1.4 Create adjacent regions graph and bilateral pairs
...
- [x] 2. Rules Engine implementation
  - [x] 2.1 Implement selectPrimaryRegion function
  ...
  - [x] 2.3 Implement mapBodyRegionToPadPlacement function
  ...
  - [x] 2.6 Implement mapGoalToModalityMix function
...
- [x] 3. History Scorer implementation
  - [x] 3.1 Implement scoreSession function
  ...
  - [x] 3.3 Implement computeConfidence function
  ...
  - [x] 3.5 Implement scoreHistory function
...
- [x] 4. Config Builder implementation
  - [x] 4.1 Implement buildConfig function
  ...
  - [x] 4.5 Implement generateChoreography function
  ...
  - [x] 4.7 Implement computeTotalDuration function
  ...
  - [x] 4.11 Implement serializeSessionConfig and deserializeSessionConfig
  ...
  - [x] 4.13 Implement clampToSafeEnvelope function
...
- [x] 5. Checkpoint — Rules Engine, History Scorer, and Config Builder
  - Ensure all tests pass, ask the user if questions arise.

- [x] 6. Recovery Map Generator
  - [x] 6.1 Implement generateRecoveryMap function
...
- [x] 7. Recovery Score Calculator
  - [x] 7.1 Implement computeRecoveryScore function
...
- [x] 8. Recovery Graph data layer
  - [x] 8.1 Implement Recovery Graph insertion and query functions
...
- [x] 9. LLM Explanation Service
  - [x] 9.1 Implement LLM prompt builder
  ...
  - [x] 9.2 Implement fallback template explanation generator
  ...
  - [x] 9.3 Implement LLM Explanation Edge Function
...
- [x] 10. Recovery Intelligence Edge Function (action router)
  - [x] 10.1 Implement the recovery-intelligence Edge Function entry point
  ...
  - [x] 10.2 Implement the `recommend` action handler
  ...
  - [x] 10.3 Implement the `recovery-map`, `recovery-score`, and `recovery-graph` action handlers
...
- [x] 11. Checkpoint — Backend Edge Functions complete
  - Ensure all tests pass, ask the user if questions arise.
